...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/qt-graphs-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qt-graphs-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install qt6-graphs
```
...
It is possible to list all of the versions of `qt6-graphs` available on your platform:
...
```
pixi search qt6-graphs --channel conda-forge
```
